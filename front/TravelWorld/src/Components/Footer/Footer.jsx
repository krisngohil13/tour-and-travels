...
import logo from "../../assets/images/Tour&Travel 1.png";
        ...
        <Row>
          ...
          <Col lg="3">
            ...
            <ListGroup className="footer__quick-links">
              ...
              <ListGroupItem className="ps-0 border-0 d-flex flex-column flex-md-row align-items-md-center gap-3">
                ...
                <p className="mb-0">
                  <Link to="tel:9876543210">+91 123456789</Link>
                </p>
              </ListGroupItem>
          ...
          <Col lg="12" className="text-center pt-5">
            <p className="copyright">
              ...
              <Link to="https://www.instagram.com/gohil.krisn?igsh=MWk5dWdibTRpajBqMA==">Gohil Krishna</Link>
            </p>
          </Col>
        </Row>
      </Container>
